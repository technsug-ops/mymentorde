...
@php
    ...
    // Aday öğrencilikten yeni promote edilen öğrenci için onboarding rehberi
    $level2Pending  = (bool) ($level2FormPending ?? false);
    $docsPending    = (int) ($pendingRequiredDocs ?? 0);
    $docsTotal      = (int) ($totalRequiredDocs ?? 0);
