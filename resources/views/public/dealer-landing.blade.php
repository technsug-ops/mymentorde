...
.d-logo { font-family:var(--font-base); font-size:28px; color:var(--primary); letter-spacing:-.5px; line-height:1; display:inline-flex; align-items:center; gap:2px; }
...
.hero::before {
 ...
 radial-gradient(60% 50% at 20% 80%, rgba(233,231,226,.15), transparent 70%);
}
...
.hero h1 em { color:var(--primary); font-style:italic; font-weight:700; }
...
.hero-visual-amount { font-family:var(--font-base); font-weight:700; font-size:56px; line-height:1; margin:0 0 8px; color:#fff; text-shadow:0 2px 16px rgba(0,0,0,.25); letter-spacing:-2px; }
...
.hero-visual-list li::before { content:''; color:#fff; font-weight:900; font-size:16px; }
...
.plan-title { font-family:var(--font-base); font-size:26px; color:var(--primary-deep); margin:0 0 8px; }
...
.cta-section::before {
 ...
 background:radial-gradient(60% 50% at 30% 20%, rgba(233,231,226,.2), transparent 70%);
 z-index:0;
}
...
.counter-value {
 font-family:var(--font-base); font-size:42px; line-height:1;
...
.calc-form h3 { margin:0 0 20px; font-size:20px; color:var(--primary-deep); font-family:var(--font-base); }
...
.calc-result-amount { font-family:var(--font-base); font-weight:700; font-size:64px; line-height:1; color:#fff; margin:0 0 8px; letter-spacing:-2.5px; text-shadow:0 2px 18px rgba(0,0,0,.28); }
...
.calc-breakdown-row:last-child { border-bottom:0; font-weight:800; color:#fff; padding-top:10px; margin-top:4px; border-top:1px solid rgba(255,255,255,.25); border-bottom:0; }
.calc-tier-badge { display:inline-flex; align-items:center; gap:6px; background:#fff; color:var(--primary-deep); padding:5px 14px; border-radius:20px; font-size:12px; font-weight:800; text-transform:uppercase; letter-spacing:.06em; margin-top:12px; box-shadow:0 4px 14px rgba(0,0,0,.18); }
...
.mockup-overlay strong { color:#fff; }
...
.testim-quote-mark {
 font-family:var(--font-base); font-size:48px; color:var(--primary-soft);
...
.tier-bar {
 flex:1; background:rgba(255,255,255,.22); border-radius:4px 4px 0 0;
...
.tier-bar .t-lbl {
 font-size:10px; color:#fff; position:absolute; bottom:-18px;
 white-space:nowrap; font-weight:700; opacity:.85;
}
.tier-bar.active .t-lbl { color:#fff; opacity:1; text-shadow:0 1px 6px rgba(0,0,0,.3); }
.tier-bar .t-val {
 writing-mode:vertical-rl; transform:rotate(180deg); font-size:10px; font-weight:800;
 color:#fff; letter-spacing:.04em; opacity:.95;
}
.tier-bar.active .t-val { color:var(--primary-deep); opacity:1; }
...
.inline-form-wrap h3 {
 font-family:var(--font-base); font-size:28px; color:var(--primary-deep);
...
<section class="sec-bg-white">
 ...
 <div class="calc-breakdown-row">
 <span> Dil Okulu (<span id="calc-lang-show">5</span> × €100)</span>
...
<section class="sec-bg-soft">
 ...
 <tr><td><strong>Büşra T.</strong><br><span style="color:var(--muted); font-size:10px;"> +90 542…</span></td><td><span class="mockup-status o">WhatsApp</span></td><td>Senior Mert</td><td style="font-size:11px; color:var(--muted);">6 saat önce</td><td><span class="mockup-status p"> 62</span></td></tr>
 <tr><td><strong>Can M.</strong><br><span style="color:var(--muted); font-size:10px;"> +90 555…</span></td><td><span class="mockup-status o">Referral</span></td><td>—</td><td style="font-size:11px; color:var(--muted);">1 gün önce</td><td><span class="mockup-status p"> 40</span></td></tr>
...
<section id="iletisim" class="cta-section">
 ...
 <div class="cta-contact">
 <a href="mailto:info@mentorde.com"
