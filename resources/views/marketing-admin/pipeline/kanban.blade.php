...
function doMove(guestId, guestName, oldStage, newStage, dz, formData) {
    ...
    fetch('/mktg-admin/pipeline/kanban/' + guestId + '/move', {
        method:'PATCH',
...
<div style="display:flex;gap:6px;margin-bottom:12px;flex-wrap:wrap;">
    <a href="/mktg-admin/pipeline" style="padding:5px 12px;font-size:11px;font-weight:600;border-radius:7px;border:1.5px solid var(--u-line);background:var(--u-card);color:var(--u-muted);text-decoration:none;">📊 Tablo</a>
    <a href="/mktg-admin/pipeline/kanban" style="padding:5px 12px;font-size:11px;font-weight:600;border-radius:7px;border:1.5px solid #7c3aed;background:#ede9fe;color:#7c3aed;text-decoration:none;">🗂 Kanban</a>
    <a href="/mktg-admin/pipeline/value" style="padding:5px 12px;font-size:11px;font-weight:600;border-radius:7px;border:1.5px solid var(--u-line);background:var(--u-card);color:var(--u-muted);text-decoration:none;">💰 Değer</a>
    <a href="/mktg-admin/pipeline/loss-analysis" style="padding:5px 12px;font-size:11px;font-weight:600;border-radius:7px;border:1.5px solid var(--u-line);background:var(--u-card);color:var(--u-muted);text-decoration:none;">📉 Kayıp</a>
</div>
        ...
        <div class="pipe-col {{ $ro ? 'ro' : '' }}">
            ...
            <div class="pipe-cards" id="kc-{{ $col['code'] }}" data-stage="{{ $col['code'] }}">
                ...
                <div class="pipe-card"
                    ...
                    @endif
                    <div class="pc-foot">
                        <a href="/mktg-admin/guests/{{ $card->id }}"
...
(function(){
    ...
    function pollPipeline() {
        ...
        _pollActive = true;
        fetch('/mktg-admin/pipeline/kanban/poll', {
