...
<div style="display:grid;gap:12px;">
        ...
        <div style="display:grid;gap:12px;">
            ...
            <details class="card">
                <summary class="det-sum">
                    <h3><x-icon name="megaphone" size="16" /> Toplu Duyuru</h3>
            ...
            <details class="card">
                <summary class="det-sum">
                    <h3><x-icon name="folder" size="16" /> Materyal Paylaşımı</h3>
                    <span class="det-chev">▼</span>
                </summary>
    ...
    <details class="card">
        <summary class="det-sum">
            <h3><x-icon name="book-open" size="16" /> Kullanım Kılavuzu — Bayi İlişkileri</h3>
            <span class="det-chev">▼</span>
        </summary>
