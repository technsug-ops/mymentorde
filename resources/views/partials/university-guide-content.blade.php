{{-- ══════════════════════════════════════════════════════════════════════════
  Shared University Guide partial — Guest + Student portals.
  Host view provides @extends + @section('content') wrapper + @include.
═══════════════════════════════════════════════════════════════════════════ --}}
...
@php
$ugIsStudent = request()->is('student/*');
$ugDiscoverRoute = $ugIsStudent ? route('student.discover', ['cat' => 'uni-content']) : route('guest.discover', ['cat' => 'uni-content']);
$ugDashboardRoute = $ugIsStudent ? route('student.dashboard') : route('guest.dashboard');
$ugCostRoute = $ugIsStudent
...
<div style="text-align:center;padding:8px 0;">
    <a href="{{ $ugDashboardRoute }}" style="color:var(--u-brand,#2563eb);font-size:var(--tx-sm);font-weight:600;text-decoration:none;">← Dashboard'a Dön</a>
    @if($ugCostRoute)
    &nbsp;·&nbsp;
    <a href="{{ $ugCostRoute }}" style="color:var(--u-brand,#2563eb);font-size:var(--tx-sm);font-weight:600;text-decoration:none;">Maliyet Hesapla →</a>
    @endif
</div>
