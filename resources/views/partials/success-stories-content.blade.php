...
.ss-city-tile img { width:100%; height:100%; object-fit:cover; display:block; }
.ss-city-tile::after {
    content:''; position:absolute; inset:0;
...
<div class="ss-cities">
    @foreach([
        ...
        ['city'=>'Hamburg',   'count'=>12, 'img'=>'https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/AlsterPanorama.jpg/600px-AlsterPanorama.jpg',  'slug'=>'hamburg'],
        ['city'=>'Frankfurt', 'count'=>9,  'img'=>'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Frankfurt_Main_August_2020_1.jpg/600px-Frankfurt_Main_August_2020_1.jpg', 'slug'=>'frankfurt'],
