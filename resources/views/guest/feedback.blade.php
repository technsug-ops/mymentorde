...
.fb-header {
    ...
    background: linear-gradient(to right, var(--theme-hero-from-guest), var(--theme-hero-to-guest));
...
.fb-field textarea:focus { border-color: var(--theme-accent-guest); box-shadow: 0 0 0 3px rgba(124,58,237,.12); }

.fb-submit {
    display: inline-flex; align-items: center; gap: 8px;
    padding: 10px 22px; border-radius: 9px;
    background: var(--theme-accent-guest); color: #fff; font-size: 13px; font-weight: 700;
    border: none; cursor: pointer; transition: background .15s; width: 100%;
    justify-content: center; margin-top: 4px;
}
.fb-submit:hover { background: var(--theme-hero-from-guest); }
...
.fb-meter { display: flex; gap: 8px; margin: 12px 0; }
.fb-meter-face {
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:start;margin-bottom:16px;">
    ...
    <div class="fb-card" style="margin-bottom:0;">
        <div class="fb-card-title">Degerlendirme Formu</div>
    ...
    <div class="fb-card" style="margin-bottom:0;">
        ...
        <div class="grid3" style="gap:10px;">
            <div style="text-align:center;padding:14px 8px;background:var(--u-bg);border:1px solid var(--u-line);border-radius:10px;">
                <div style="font-size:var(--tx-2xl);font-weight:800;color:var(--theme-accent-guest);">{{ $total }}</div>
