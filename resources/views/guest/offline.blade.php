...
<head>
    ...
    <title>MentorDE — Çevrimdışı</title>
    <style>
...
<body>
    <div class="card">
        ...
        <div class="contact">
            <strong>Acil durumda danışmanınıza ulaşın:</strong><br>
            E-posta üzerinden mesaj göndermek için bağlantınız gelene kadar bekleyiniz.<br><br>
            <strong>Destek:</strong> destek@mentorde.de
        </div>
    </div>

    <script>
        // Bağlantı geldiğinde otomatik yönlendir
