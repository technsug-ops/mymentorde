...
{{-- Hero --}}
<div class="card" style="background:linear-gradient(135deg,#0891b2,#0e7490);color:#fff;margin-bottom:20px;">
    ...
    <div class="card">
        <div class="card-body" style="padding:20px 24px;">
            ...
            @foreach([
                ...
                ['Motivasyon mektubu (bazı konsolosluklarda)',      'warn'],
            ] as [$doc, $db])
...
{{-- CTA --}}
<div class="card" style="background:linear-gradient(135deg,#0891b2,#0e7490);color:#fff;margin-bottom:16px;">
    <div class="card-body" style="padding:20px 24px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px;">
        ...
        <a href="{{ route('guest.messages') }}" class="btn" style="background:#fff;color:#0891b2;font-weight:700;flex-shrink:0;">
            Danışmana Yaz →
        </a>
    </div>
</div>
