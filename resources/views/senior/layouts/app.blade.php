        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section" data-acc-key="ogrenci">
                ...
                <div class="nav-acc-body" style="{{ $isOgrenci ? '' : 'display:none;' }}">
                    {{-- #14: Öğrencilerim = tek hub (liste + Süreç Panosu toggle). "Başvuru & Süreç" ayrı link kaldırıldı, sayfa içi geçişe taşındı. --}}
                    <a href="/senior/students"               class="nav-link {{ request()->is('senior/students*','senior/process-tracking*','senior/university-applications*','senior/visa*','senior/housing*') ? 'active' : '' }}"><x-icon name="graduation-cap" size="18" class="nav-icon" aria-label="Öğrencilerim" /> Öğrencilerim @if(($deadlineIn7 ?? 0) > 0)<span style="background:#dc2626;color:#fff;border-radius:999px;font-size:10px;font-weight:700;padding:1px 6px;margin-left:4px;">{{ $deadlineIn7 }}</span>@endif</a>
                    ...
                    <a href="/senior/guest-pipeline"         class="nav-link {{ request()->is('senior/guest-pipeline*') ? 'active' : '' }}"><x-icon name="users" size="18" class="nav-icon" aria-label="Aday Öğrenci Pipeline" /> Aday Öğrenci Pipeline</a>
                    <a href="/senior/student-pipeline"       class="nav-link {{ request()->is('senior/student-pipeline*') ? 'active' : '' }}"><x-icon name="kanban" size="18" class="nav-icon" aria-label="Pipeline Kanban" /> Pipeline Kanban</a>
