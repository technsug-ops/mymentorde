...
Route::middleware(['company.context', 'auth', 'verified', 'guest.role', 'throttle:600,1'])->prefix('guest')->group(function (): void {
    ...
    Route::get('/gdpr/export', [GdprController::class, 'exportGuestData'])->middleware('throttle:20,60')->name('guest.gdpr.export');
    ...
    Route::post('/feedback', [GuestWorkflowController::class, 'storeFeedback'])->middleware('throttle:120,1')->name('guest.feedback.store');
    Route::post('/nps',      [GuestWorkflowController::class, 'storeNps'])->middleware('throttle:120,1')->name('guest.nps.store');
