        ...
        return [
            ...
            [
                ...
                'fields' => [
                    ...
                    self::f('passport_number', 'Pasaport seri numarası', 'text', false, 64, placeholder: 'Örn: SDCF123444', help_text: 'ÖNEMLİ: Pasaport seri numaran "U" harfi ile başlıyorsa Umuma Mahsus (REISEPASS) — Almanya öğrenci vizesi için bu pasaport tipi gereklidir. "S" ile başlıyorsa Hizmet/Yeşil Pasaport (SONDERNPASS) — vize muafiyetin olabilir, ama uzun süreli öğrenci ikametinde yine de oturum izni başvurusu yapman gerekir. Farklı bir harfle başlıyorsa danışmanına bildir.', level: 1),
                    ...
                    self::f('visa_history_details', 'Vize başvurusu detayı', 'textarea', false, 1000, placeholder: 'Örn: 2022 yılında Almanya öğrenci vizesine başvurdum, kabul/red sonucu...', help_text: 'Hangi ülke, ne zaman, sonuç (kabul/red) — kısaca not düşebilirsin.'),
                    ...
                    self::f('abroad_experience_details', 'Yurt dışı deneyimi detayı', 'textarea', false, 1000, placeholder: 'Örn: 6 ay İngiltere\'de Erasmus / 1 yıl Hollanda\'da staj...', help_text: 'Hangi ülke, ne kadar süre, ne tür deneyim (eğitim/staj/iş).'),
                    self::f('has_health_condition', 'Özel bir sağlık durumu/gereksiniminiz var mı? *', 'select', true, 10, options: self::yesNoOptions()),
                    self::f('health_condition_details', 'Sağlık durumu açıklaması', 'textarea', false, 1000, placeholder: 'Almanya başvurun ya da yaşam koşulların için bilmemiz gereken bilgi varsa kısaca yaz.', help_text: 'Bu bilgi gizli tutulur, sadece danışmanın görür.'),
                    ...
                    self::f('other_country_details', 'Hangi ülkeleri düşündünüz?', 'textarea', false, 500, placeholder: 'Örn: Hollanda, Avusturya, Kanada — neden Almanya\'yı seçtin?', help_text: 'Bu bilgi danışmanına sana özel rehberlik için yardımcı olur.'),
